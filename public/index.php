...
<html lang="id">
<head><script>
if (!localStorage.getItem('jadf_demo')) {
  localStorage.setItem('jwt_token', 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOjEsInJvbGUiOiJhZG1pbiIsIm5hbWUiOiJEZW1vIEFkbWluIn0.demo');
  localStorage.setItem('user', JSON.stringify({id:1,name:'Demo Admin',role:'admin'}));
  localStorage.setItem('jadf_demo', '1');
}
</script>
    ...
    <header x-data="{ mobileMenuOpen: false, searchOpen: false }" class="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <a href="#" class="flex-shrink-0">
                    <img src="" alt="Wenshop Hot Wheels" class="h-10">
                </a>
                <!-- Desktop Navigation -->
                <nav class="hidden lg:flex space-x-8">
                    <a href="#" class="text-gray-900 hover:text-red-600 font-medium">Home</a>
                    <a href="#" class="text-gray-700 hover:text-red-600">Products</a>
                    <a href="#" class="text-gray-700 hover:text-red-600">Flash Sale</a>
                    <a href="#" class="text-gray-700 hover:text-red-600">Premium</a>
                    <a href="#" class="text-gray-700 hover:text-red-600">Collector Edition</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-50">
                            ...
                            <!-- @if demo: shown -->->isAdmin())
                            <hr class="my-1">
                            <a href="#" class="block px-4 py-2 text-red-600 hover:bg-gray-100">Admin Panel</a>
                            <!-- @endif demo -->
                            <hr class="my-1">
        ...
        <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" class="lg:hidden bg-white border-t">
            <div class="px-4 py-3 space-y-2">
                ...
                <a href="#" class="block py-2 text-gray-700">All Products</a>
                <a href="#" class="block py-2 text-red-600 font-semibold">🔥 Flash Sale</a>
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="#" class="bg-red-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-red-700 transition">
                                Shop Now
                            </a>
                            <a href="#" class="bg-yellow-500 text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-400 transition">
                                Flash Sale 🔥
                            </a>
                        </div>
                    </div>
                    <div class="hidden md:block">
                        <img src="#" alt="Hot Wheels Collection" class="rounded-lg shadow-2xl">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4 py-4">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div>
                        ...
                        <span class="ml-4 text-lg font-semibold" x-data="countdown('')" x-text="timeLeft"></span>
                    </div>
                    <a href="#" class="bg-gray-900 text-white px-6 py-2 rounded-lg font-semibold hover:bg-gray-800">
                        Lihat Semua
                    </a>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition duration-300 overflow-hidden group">
                    ...
                    <div class="p-4">
                        ...
                        <a href="#" class="block mt-1">
                            <h3 class="text-sm font-semibold text-gray-900 line-clamp-2 hover:text-red-600"></h3>
                        </a>
                        <div class="mt-2 flex items-center justify-between">
                            <div>
                                <!-- @if demo: shown -->
                                <span class="text-xs text-gray-400 line-through">Rp </span>
                                <span class="text-lg font-bold text-red-600">Rp </span>
                                <!-- <!-- @else demo: hidden --> demo: hidden -->
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
                ...
                <div class="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="text-sm font-semibold text-gray-900 line-clamp-2 mt-1"></h3>
                        <div class="mt-2">
                            <span class="text-lg font-bold text-gray-900">Rp </span>
                        </div>
                    </div>
    ...
    <footer class="bg-gray-900 text-gray-300 py-12">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    <img src="" alt="Wenshop Hot Wheels" class="h-8 mb-4">
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-sm">
                <p>&copy;  Wenshop Hot Wheels. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <script>
